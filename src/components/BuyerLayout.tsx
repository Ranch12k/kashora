...
import { categoryAPI, Category, publicProductAPI, cartAPI, settingsAPI, SiteSettings } from '../services/api';
      ...
      <header className="byr-header">
        <div className="byr-header__main">
          {siteSettings?.site_logo ? (
            <Link to="/products" className="byr-logo byr-title-font" style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <div className="byr-catnav">
            <div className="byr-catnav__inner">
              {categories.filter(c => !c.parent).slice(0, 10).map(cat => {
                ...
                const imgSrc = cat.image || fallbackImg || "https://images.unsplash.com/photo-1472851294608-062f824d29cc?q=80&w=150&auto=format&fit=crop";
